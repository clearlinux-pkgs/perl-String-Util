...
%prep
%setup -q -n String-Util-1.31
cd %{_builddir}/String-Util-1.31
...
cp %{_builddir}/String-Util-1.31/LICENSE %{buildroot}/usr/share/package-licenses/perl-String-Util/5a495047fa17d9b0c6f4e19c3061305ee5a8acdd
if test -f Makefile.PL; then
